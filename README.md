Strafing Dummy mod for r5 flowstate aim trainer. Speed adjusts strafe length(from shortest to longest). If you enable Play As Dummy, bot will have variable strafe lengths.
